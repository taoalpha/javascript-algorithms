...
* **搜索**
  ...
  * `B` [插值搜索](src/algorithms/search/interpolation-search) - 搜索均匀分布的排序数组
* **排序**
...
你可以在`./src/playground/playground.ts`文件中操作数据结构与算法, 并在`./src/playground/__test__/playground.test.ts`中编写测试。
